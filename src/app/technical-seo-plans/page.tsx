    ...
    <main className="min-h-screen bg-zinc-50 dark:bg-black selection:bg-blue-100 dark:selection:bg-blue-900 overflow-x-hidden w-full relative">
      ...
      <section className="pt-40 pb-16 px-6 text-center max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-zinc-900 dark:text-white mb-6 tracking-tight">
          Our Technical SEO plans
        </h1>
        <p className="text-xl text-zinc-600 dark:text-zinc-400 leading-relaxed">
          Choose the perfect technical SEO plan for your website needs and budget from our comprehensive analysis packages.
        </p>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-32">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <PricingCard 
            title="Light"
            description="Foundational with comprehensive analysis"
            ...
            features={[
              ...
              "Sitemap analysis recommendations",
          ...
          <PricingCard 
            title="Medium"
            description="Accelerate performance with expert guidance"
            price="Under development"
            listTitle="Deliverables"
            isPopular
            features={[
          ...
          <PricingCard 
            title="Premium"
            description="Dominate with comprehensive consultation"
            price="Under development"
            listTitle="Deliverables"
            features={[
              "Technical SEO audit",
