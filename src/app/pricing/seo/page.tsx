...
function PricingCard({ title, description, price, features, isPopular }: PricingCardProps) {
  return (
    <div className={`flex flex-col rounded-3xl overflow-hidden border transition-all duration-300 hover:-translate-y-1 ${
      ...
      {/* 👇 NEW: Lighter, see-through background tint for the entire top section */}
      <div className={`relative p-8 ${
        isPopular 
          // Subtle blue/purple glow over the dark card
          ...
          // Very light, see-through blue/purple wash on the light cards
        ...
        {/* Reverted the text to look clean and professional */}
